'use strict';
const CACHE='photobearrate-v5',PRECACHE=['/static/manifest.json','/static/icons/icon.svg'],SKIP=['/rate','/next-image','/reset','/feedback','/set-name','/clear-name','/login','/logout','/admin','/img','/stories'];
...
self.addEventListener('push', event => {
    ...
    const title = payload.title || '🐻 PhotoBearRate';
    event.waitUntil(
